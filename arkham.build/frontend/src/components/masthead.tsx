...
export function Masthead(props: Props) {
  ...
  const isLocalIntegration = import.meta.env.VITE_LOCAL_INTEGRATION === "true";
  const logoContent = (
    <>
      <Logo />
      <span className={css["logo-name"]}>{import.meta.env.VITE_PAGE_NAME}</span>
    </>
  );
  ...
  return (
    ...
    >
      <div className={css["left"]}>
        {isLocalIntegration ? (
          <a className={css["logo"]} href="/" data-testid="masthead-logo">
            {logoContent}
          </a>
        ) : (
