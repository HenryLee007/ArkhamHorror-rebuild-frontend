  ...
  <div class="admin-shell" :class="{ 'sidebar-open': sidebarOpen }">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <a class="nav-link" :class="{ active: selected == 'users' }" href="#/admin/users">
          <!-- users icon -->
        ...
        <div class="nav-section">洞察</div>
        <a class="nav-link" href="#"><svg viewBox="0 0 24 24"><path d="M3 13h2v-2H3v2zm4 0h14v-2H7v2zM3 17h2v-2H3v2zm4 0h14v-2H7v2zM3 9h2V7H3v2zm4 0h14V7H7v2z" fill="currentColor"/></svg>报表</a>
        <a class="nav-link" href="#"><svg viewBox="0 0 24 24"><path d="M11 17h2v-6h-2v6zm0-8h2V7h-2v2zm1-7C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="currentColor"/></svg>状态</a>
      </nav>

      <div class="sidebar-footer">
        <button class="collapse" @click="toggleSidebar" aria-label="切换侧边栏">
